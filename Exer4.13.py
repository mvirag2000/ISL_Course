...
# design = MS(['year', 'origin', 'acceleration', 'displacement', 'horsepower', 'weight', ('horsepower', 'weight')]) # R2 = 0.862  F = 342 
design = MS(['year', 'origin', 'horsepower', 'weight', ('horsepower', 'weight')]) # R2 = 0.861 F = 477 
...
axx1.scatter(results.fittedvalues, results.resid_pearson, s=9)
axx1.set_xlabel('Fitted Values')
axx1.set_ylabel('Residuals')
axx1.axhline(0, c='red', linewidth=2)
axx2 = fig2.add_subplot(1,2,2)
axx2 = sm.graphics.plot_leverage_resid2(results, ax = axx2, markersize=3)
plt.show()